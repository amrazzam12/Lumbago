                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-4">
                                ...
                                <input type="time" name="from_hour" class="form-control" id="from" value="09:00">
                            </div>

                            <div class="form-group col-4">
                                <label for="to">To</label>
                                <input type="time" name="to_hour" class="form-control" id="to" value="18:00">
                            </div>

                            <div class="form-group col-4">
                                <label for="price">Price</label>
                                <input type="number" name="price" class="form-control" id="price" placeholder="Appointment Price">
                            </div>
